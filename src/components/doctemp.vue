<template>
  <table
    ...
    cellspacing="0"
    width="700"
    style="font-size: 14px;border-spacing: 0px;border-collapse:collapse;text-align:center;"
  >
    <!-- <caption align="top" style="font-size: 18px;font-weight: bold;">扬州供电公司违约用电处理通知单</caption> -->
    <tr height="45">
      <th
        colspan="7"
        style="border: 0px solid black;font-size:20px;font-weight:bold;"
      >扬州供电公司违约用电处理通知单</th>
    </tr>
    <tr height="30">
      <th width="50">户名</th>
      <th width="140" style="color:red">扬州塑业有限公司</th>
      <th width="60">户号</th>
      <th width="100" style="color:red">910128412</th>
      <th width="100">地址</th>
      <th colspan="2" width="200" style="color:red">扬州市杭集镇</th>
    </tr>
    <tr height="180">
      <td rowspan="10"></td>
      <td
    ...
    <tr height="30" style="color:red;text-align: center;">
      <td>2018/12月</td>
      <td>250</td>
      <td>260</td>
      <td>0</td>
    ...
    <tr height="30" style="text-align: center;">
      <td
        style="border-top: 0px solid black;border-left: 0px solid black;border-right: 0px solid black;"
      >&nbsp;</td>
      <td
        style="border-top: 0px solid black;border-left: 0px solid black;border-right: 0px solid black;"
      >&nbsp;</td>
